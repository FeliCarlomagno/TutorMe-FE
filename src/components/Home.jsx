    ...
    <>
      ...
      <Container className="container_center">
        <Row className="row_center_top d-flex justify-content-center">
          ...
          <Col>
            ...
            <p>
              Consulta liberamente i profili e contatta l'insegnante che fa per te secondo le tue esigenze
              (tariffe, diploma, commenti, lezioni online o a domicilio).
            </p>
          </Col>
        </Row>
        ...
        <Row className="row_center">
          <Col>
            ...
            <p>
              Veloci come un lampo, gli insegnanti ti rispondono in qualche ora! E se non trovi l'insegnante
              perfetto, la nostra equipe ti aiuterà nella ricerca.
            </p>
          </Col>
          <Col xs={12} sm={12} md={12} lg={6}>
            <div className="d-flex justify-content-center">
        ...
        <Row className="row_center_end">
          ...
          <Col>
            ...
            <p>
              Discuti e programma le lezioni con il tuo insegnante o istruttore direttamente tramite la
              messaggeria del tuo account.
            </p>
          </Col>
        </Row>
      </Container>
      ...
      <Container id="container_carousel">
        <Carousel className="carousel_home">
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <div className="text-dark text-start ">
                ...
                <p className="fs-6">
                  "Tutorme è la piattaforma che ha permesso ai miei due figli di migliorare i loro voti, di
                  sviluppare un vero metodo di studio e di avere maggiore fiducia in loro stessi."
                </p>
          ...
          <Carousel.Item>
            <img className="img_carousel rounded-4" src="/assets/friendly-students.jpg" alt="Second slide" />

            <Carousel.Caption>
              <div className="text-dark text-start">
                <h3>Imparare può essere divertente:</h3>
                <p className="fs-6">
                  Le lezioni online possono sembrare noiose e monotone, ma questo sito ha il potere di rendere
                  lo studio divertente e coinvolgente. Non solo ho imparato tantissimo, ma mi sono anche
                  divertito lungo il percorso!
                </p>
          ...
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <div className="text-dark text-start">
                ...
                <p className="fs-6">
                  Gli insegnanti sono eccezionali e riescono a trasmettere la loro passione per il sapere in
                  modo contagioso. Ho avuto l'impressione di essere seduto in una classe con il professore
                </p>
